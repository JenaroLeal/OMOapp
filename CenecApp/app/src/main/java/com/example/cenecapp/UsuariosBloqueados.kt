...
class UsuariosBloqueados : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_usuarios_bloqueados)
        ...
        val arrayEmail = usuario.usuariosBloqueados
        ...
        db.collection("Usuarios").get().addOnSuccessListener {
            ...
            val adapter: UsuariosBloqueadosAdapter = UsuariosBloqueadosAdapter(this,valores)
            val recyclerView: RecyclerView =findViewById<RecyclerView>(R.id.contenedorReciclerBloqueados)
